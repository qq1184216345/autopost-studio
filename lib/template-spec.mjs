...
export const SUPPORTED_PLATFORMS = ['xhs', 'douyin', 'wxsph', 'mp'];
export const PLATFORM_LABEL = { xhs: '小红书', douyin: '抖音', wxsph: '视频号', mp: '公众号' };
export const PLATFORM_TITLE_MAX = { xhs: 20, douyin: 30, wxsph: 22, mp: 20 };
