...
export async function publishXhs(ctx, { imgPath, title, body, hashtags = [], mode, titleMaxLen = 20 }) {
  ...
  try {
    ...
    await page.setInputFiles('input[type=file].upload-input, input[type=file]', imgPath);
